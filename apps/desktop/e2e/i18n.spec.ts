...
test("Russian is default; language and theme persist without changing project content", async ({
  ...
  await page.screenshot({
    path: "../../docs/verification/1.0.0-dashboard-ru.png",
  });
  await page
  ...
  await page.screenshot({
    path: "../../docs/verification/1.0.0-settings-ru.png",
  });
  ...
  await page.screenshot({
    path: "../../docs/verification/1.0.0-settings-en-light.png",
  });
  await page.reload();
...
test("Russian workspace translates features, tooltips and confirmations but preserves model IDs", async ({
  ...
  await page.screenshot({
    path: "../../docs/verification/1.0.0-workspace-ru.png",
  });
  await page
  ...
  await page.screenshot({
    path: "../../docs/verification/1.0.0-features-ru.png",
  });
  await page
